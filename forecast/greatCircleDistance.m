function d = greatCircleDistance(lat_s, long_s, lat_f, long_f, r)
...
%
% INPUTS:
% lat_s    = latitude of the standpoint (base) [deg]
% long_s = longitude of the standpoint (base) [deg]
% lat_f    = latitude of the forepoint (destination) [deg]
% long_f = longitude of the forepoint (destination) [deg]
...
phi_s = lat_s*pi/180;
lambda_s = long_s*pi/180;
phi_f = lat_f*pi/180;
lambda_f = long_f*pi/180;

% convert from structure (degrees minutes seconds) to radians as needed
