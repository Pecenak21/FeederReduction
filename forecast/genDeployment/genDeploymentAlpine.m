...
c = feederSetup('alpine','validated');
...
pv2 = load([normalizePath('$KLEISSLLAB24-1')  '/database/gridIntegration/PVimpactPaper/virtualPV/f355scenario2_pv.mat']);
pv2 = pv2.pv;
pv = struct();
for i = 1:length(pv2)
